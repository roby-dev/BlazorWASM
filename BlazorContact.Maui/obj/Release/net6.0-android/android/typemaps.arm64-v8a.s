...
map_modules:
	...
	.byte	0x8, 0x21, 0xf7, 0xd2, 0x45, 0x60, 0x7b, 0x48, 0xb2, 0x3c, 0x22, 0x3e, 0x94, 0x72, 0x37, 0x35	// module_uuid: d2f72108-6045-487b-b23c-223e94723735
	...
	.byte	0xba, 0x28, 0xad, 0x27, 0xc8, 0xb4, 0xe2, 0x48, 0x89, 0x37, 0xb5, 0x1, 0x53, 0x91, 0xb5, 0x2e	// module_uuid: 27ad28ba-b4c8-48e2-8937-b5015391b52e
	...
	.byte	0xc1, 0x35, 0x9b, 0x1f, 0x6d, 0x72, 0x11, 0x48, 0x8b, 0xb2, 0x28, 0x50, 0x6a, 0x83, 0xa0, 0x2f	// module_uuid: 1f9b35c1-726d-4811-8bb2-28506a83a02f
	.word	0x2	// entry_count
	.word	0x0	// duplicate_count
	.xword	.L.module24_managed_to_java	// map
	.xword	0	// duplicate_map
	.xword	map_aname.24	// assembly_name: BlazorContact.Maui
	.xword	0x0	// image
	.word	0x0	// java_name_width
	.zero	4
	.xword	0x0	// java_map
	...
	.byte	0xd2, 0x46, 0xc1, 0x22, 0x1c, 0xc2, 0x46, 0x4d, 0x91, 0x5c, 0x4f, 0x86, 0xa1, 0xe2, 0xbd, 0x3e	// module_uuid: 22c146d2-c21c-4d46-915c-4f86a1e2bd3e
	.word	0x5	// entry_count
	.word	0x0	// duplicate_count
	.xword	.L.module28_managed_to_java	// map
	.xword	0	// duplicate_map
	.xword	map_aname.28	// assembly_name: Microsoft.AspNetCore.Components.WebView.Maui
	.xword	0x0	// image
	.word	0x0	// java_name_width
	.zero	4
	.xword	0x0	// java_map
...
map_java:
	...
	.word	0x2000009	// type_token_id
	.ascii	"crc6413d200a6b200b048/MainActivity"	// java_name
	.zero	69	// byteCount == 34; fixedWidth == 103; returned size == 103
	.zero	1

	.word	0x18	// module_index
	.word	0x200000a	// type_token_id
	.ascii	"crc6413d200a6b200b048/MainApplication"	// java_name
	.zero	66	// byteCount == 37; fixedWidth == 103; returned size == 103
	.zero	1
